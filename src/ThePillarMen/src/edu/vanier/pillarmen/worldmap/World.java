...
public class World extends Region {
    ...
    private static final String                          HIRES_PROPERTIES = "src/edu/vanier/pillarmen/worldmap/ressources/hires.properties";
    private static final String                          LORES_PROPERTIES = "src/edu/vanier/pillarmen/worldmap/ressources/lores.properties";
    ...
    private Properties readProperties(final String FILE_NAME) {
        ...
        try(InputStream resourceStream = new FileInputStream(FileHelper.getAbsolutePath(FILE_NAME))) {
    ...
    @Override public String getUserAgentStylesheet() {
        return World.class.getResource("/edu/vanier/pillarmen/worldmap/ressources/world.css").toExternalForm();
    }
    ...
    public void parseData(String iso3Key){
        MonthlyPrecipitationParser precipitation = new MonthlyPrecipitationParser();
        AverageMonthlyPrecipitation monthlyPre = precipitation.parseAverageMonthlyPre(iso3Key, "1980", "1999");
        System.out.println(monthlyPre);
        
        MonthlyTempParser temperatureMonthly = new MonthlyTempParser();
        AverageMonthlyTemp monthlyTemp = temperatureMonthly.parseAverageMonthlyTemp(iso3Key, "1980", "1999");
        System.out.println(monthlyTemp);
        
        AnnualTempParser temperatureAnnual = new AnnualTempParser();
        AverageAnnualTemp annualTemp = temperatureAnnual.parseAverageAnnualTemp(iso3Key, "1980", "1999");
